...
bool DTcpClient::ConnectToServer(const char *ip, const int port)
{
...
bool DTcpClient::Read(char *buffer, const int itimeout)
{
...
bool DTcpClient::Write(const char *buffer, const int ibuflen)
{
    if (m_sockfd == -1) return false;
...
bool DTcpClient::TcpWrite(const int sockfd, const char *buffer, const int ibuflen)
{
...
bool DTcpClient::Writen(const int sockfd, const char *buffer, const size_t n)
{
...
bool DTcpClient::Readn(const int sockfd, char *buffer, const size_t n)
{
    int nLeft, nread, idx;
...
bool DTcpClient::TcpRead(const int sockfd, char *buffer, int *ibuflen, const int itimeout)
{
    if (sockfd == -1) return false;
